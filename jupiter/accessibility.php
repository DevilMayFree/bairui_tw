...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/announcement.css">
</head>
<body>
    <div id="header_outer">
    <header>
    ...
    <div class="main_padding">
        <div class="w1200">
            <h5>
                百瑞發投資股份有限公司官方網站（以下簡稱本網站）為先機環球基金在台灣之入口網站：國內基金交易服務由百瑞發投資股份有限公司提供；投資理財相關資訊服務由百瑞發投資股份有限公司提供。內容限由台灣地區居民使用。
                <br><br>
                本網頁解釋有關散佈本網站資訊之適用法律及主管機構限制規定之說明。任何查閱本網站所載資料的使用者，均有責任遵守本國適用的法令規範及主管機關之規定。繼續瀏覽本網頁即表示您同意遵守上述規定。 
                <br><br>
                本網站資訊由百瑞發投資股份有限公司所提供，百瑞發投資股份有限公司自當盡力透過本網頁為讀者及客戶提供正確的意見及消息，但如有錯漏或疏忽，百瑞發投資股份有限公司或關係企業與其任何董事或受僱人，並不就該等資料負任何法律責任。本網站亦包括由第三人所提供之資訊，百瑞發投資股份有限公司亦不對此負擔任何責任。使用者對此等資料或其任何部份在任何情況下均不得予以抄錄、複印或另作他用。
                <br><br>
                本網站之資訊乃免費提供。若您繼續進入本網站此網頁以後之部分，即視為您同意免除就本網站提供之資訊所生之一切責任。百瑞發投資股份有限公司對凡因使用或依賴該等資訊所受一切損害或損失（包括但不限於所失利益，及直接或間接所受損失），皆不負任何責任。
                <br><br>
                本網站所載資料的所有版權、專利權、著作權及其他產權均屬百瑞發投資股份有限公司所有。使用者未經百瑞發投資股份有限公司書面同意，不得就此等資料為任何利用。
                <br><br>
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#cfbcaabdb9a6acaa8faca8bca6acaae1aca0a2" class="txt-orange"><span class="__cf_email__" data-cfemail="d4a7b1a6a2bdb7b194b7b3a7bdb7b1fab7bbb9">[email&#160;protected]</span></a></p>
