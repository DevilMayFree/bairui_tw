...
<script src="js/main.js" defer></script>    <link rel="stylesheet" href="css/about.css">
</head>
<body>
    <div id="header_outer">
    <header>
    ...
    <div class="inner w1200 txt-white">
        <div class="text">
            <h2 class="h1 txt-bold" id="banner_title">關於百瑞發投資</h2>
            <h5></h5>
        </div>
    </div>
</div>
        ...
        <div class="text_block main_padding">
            <div class="inner w1200">
                ...
                <p>
                    ...
                    <br><br>
                    百瑞發投資提供最即時、完整、專業的市場訊息，並舉辦投資說明會，提供每月或每季投資趨勢，亦不定期與先機投資集團或基金經理人進行視訊，與先機投資集團分享、交流研究心得，不定期邀請先機環球投資經理人來台，與台灣投資人近距離說明基金操作現況與分享最新投資想法，百瑞發投資與先機投資集團將發揮最大的合作綜效以提供國際化且優質的財富管理服務。
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="content w1400">
        ...
        <div class="content_bottom">
            <div class="item">
                ...
                <p>客服信箱：<a href="/cdn-cgi/l/email-protection#5f2c3a2d29363c3a1f3c382c363c3a713c3032" class="txt-orange"><span class="__cf_email__" data-cfemail="96e5f3e4e0fff5f3d6f5f1e5fff5f3b8f5f9fb">[email&#160;protected]</span></a></p>
